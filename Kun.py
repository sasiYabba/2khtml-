<!DOCTYPE html>
<html>
<head>                                            <meta charset="utf-8" />                          <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />                               <meta http-equiv="X-UA-Compatible" content="IE=Edge,chrome=1" />
<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />             <meta name="robots" content="noindex, nofollow" /><title>Sorry, you have been blocked.</title>
...
<div class="text-xl md:text-2xl font-light mt-4 md:mt-8">You are unable to access the domain. </div>
</div>
</main>
<footer class="h-10 text-xs md:text-sm text-center">
<span>
DomaiNesia Req ID: ad7d6df3331ed31d4bb21b2ebb82493b</span>
<span>
&#8226;
</span>
<span>
Your IP: 103.21.166.253</span>
<span>
&#8226;
</span>
</span>
